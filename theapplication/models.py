...
class Application(models.Model):
    ...
    gender = models.CharField(max_length=2, choices=GENDER_CHOICES, default="P_")
    ...
    grad_year = models.CharField(
        max_length=2, choices=YEAR_IN_SCHOOL_CHOICES, default="or"
    )
...
class Confirmation(models.Model):
    ...
    shirt_size = models.CharField(
        max_length=2, choices=SHIRT_SIZE_CHOICES, default="M_"
    )
